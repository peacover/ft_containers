...
/*   Updated: 2022/03/06 19:50:19 by yer-raki         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
namespace ft
{
	...
	class random_access_iterator : ft::iterator<std::random_access_iterator_tag, T>
	{
		...
		public:
			...
			random_access_iterator(random_access_iterator const & src) { return (*this = src); }
			...
			bool operator==(random_access_iterator const & src) { return (_ptr == src._ptr); }
			bool operator!=(random_access_iterator const & src) { return (_ptr != src._ptr); }
